...
export default function BottomPage() {
    return (
        <main>
            <div className="bg-slate-900 text-center text-white h-[250px] flex flex-row py-6 px-[30vw]">
      ...
      <div className="bg-slate-100 h-[150px] text-center p-7 font-sans text-md">
